...
import { circlePiece, CoupleEating } from "@/app/utils";
    ...
    <div className="relative translate-y-[20%] h-[100vmin] w-full  flex flex-col md:flex-row p-10">
      ...
      <div className="absolute inset-y-[20%] left-[50%] translate-x-[0%] translate-y-[-16%]">
        ...
        <p className="font-inter font-[300] text-[clamp(8px,1.67vw,18px)] leading-[clamp(29.05px,2.5vw,29.05px )] pt-[clamp(3px,1vw,24px)] text-white/70">
          ...
          1500s, when an unknown printer took a galley of typex and scrambled it
        ...
        <div className="absolute inset-x-[12%] right-[50%] translate-y-[90%] translate-x-[-16%] w-[13.89vw] h-[13.89vw] rotate-45 z-[-1]">
          <Image
            src={circlePiece}
            width={170}
            height={170}
