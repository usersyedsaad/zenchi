...
import { sideSpegatte } from "@/app/utils";

const SubLandingPage5 = () => {
  return (
    <div className="relative translate-y-[20%] h-[100vmin] w-full  flex flex-col md:flex-row p-10">
      <div className="absolute inset-x-[12%] right-[50%] translate-y-[0%] translate-x-[-16%]">
        ...
        <p className="font-inter font-[300] text-[clamp(8px,1.67vw,18px)] leading-[clamp(29.05px,2.5vw,29.05px )] pt-[clamp(3px,1vw,24px)] text-white/70">
          ...
          ever since the 1500s, when an unknown printer took a galley of typex
      ...
      <div className="relative h-[clamp(50px,54.3vw,782px)] w-[clamp(50px,43.47vw,626px)] left-[45%] translate-y-[-50%] top-[20%] ">
        <Image
          src={sideSpegatte}
          fill
          alt="side spegatte view"
